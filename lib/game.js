...
class Game {
    ...
    renderBackground(ctx) {
        ...
        this.background.onload = () => {
            ...
            ctx.drawImage(this.background, this.x2Pos, 0, this.window.innerWidth, this.window.innerHeight);
        }

        if (this.x2Pos == 0) this.xPos = 0;
        if (this.xPos == 0) this.x2Pos = this.window.innerWidth;
